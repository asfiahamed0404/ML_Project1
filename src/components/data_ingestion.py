# reading data
import os   #used for file/folder operations (paths, making directories)
import sys  #used for system/interpreter info (especially useful in custom error handling)
...
class DataIngestion:  
  def __init__(self):  #Constructor
    self.ingestion_config = DataIngestionConfig()  #that  3 paths will save in this variable
